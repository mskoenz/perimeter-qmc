...
namespace perimeter {
    ...
    public:
              ...
              , grid_(boost::extents[H_][L_]) 
       {
        ...
        void init_loops() {
            if(n_loops_[qmc::start] != 0) {//can only be called once at the start
    ...
    private:
        ...
        loop_type n_loops_[qmc::n_bra];
        std::vector<loop_type> available_[qmc::n_bra];
        state_type alternator_[qmc::n_bra];
    };
